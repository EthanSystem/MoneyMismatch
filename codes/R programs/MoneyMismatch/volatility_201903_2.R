...
# 把0值赋予一个极小偏移量
data_used$data[data_used$data==0] <- minimum_offset_value
...
data_used.gradient$data[data_used.gradient$data==0] <- minimum_offset_value
