...
# 输出的数据的数据表名称
output_data.sheet_name<-"中国"

## 代入程序运算
programs_function(input_data.sheet_name,output_data.sheet_name,data_used.time.keyword)
...
##### functions ###################
programs_function <- function(input_data.sheet_name,output_data.sheet_name,data_used.time.keyword,) {
