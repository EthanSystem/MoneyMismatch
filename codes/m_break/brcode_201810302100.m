...
data_y = table_data_original.CNY(1:numEffectiveSample);
data_x = ones(numEffectiveSample,1);
data_z = [table_data_original.USD(1:numEffectiveSample), table_data_original.EUR(1:numEffectiveSample), table_data_original.JPY(1:numEffectiveSample), table_data_original.KRW(1:numEffectiveSample), EMP];
                           
numRegressorsZ=5;                      % number of regressors data_z
numRegressorsX=1;                      % number of regressors data_x 
maxStructuralChanges=5;                      % maximum number of structural changes allowed
eps1=0.15;                 % value of the trimming (in percentage) for the construction 
