...
data_original=csvread('real.csv');  % read data
numEffectiveSample=103;                  % set effective sample size
data_y=data_original(1:103,1);            % set up the data, data_y is the dependent variable data_z is 
...
numRegressorsX=0;                      % number of regressors data_x 
...
minSizeOfSegment=15;       % minimal length of a segment (minSizeOfSegment >= numRegressorsZ). Note: if isHeterogeneityAndAutocorrelation=1, minSizeOfSegment 
