...
% 需要计算的部分数据。
% 2000年1月至2005年3月，对应第1-63号。
table_calculate_data=table_original_data(1:63,:);
...
minSizeOfSegment=6;       % minimal length of a segment (minSizeOfSegment >= numRegressorsZ). Note: if isHeterogeneityAndAutocorrelation=1, minSizeOfSegment 
