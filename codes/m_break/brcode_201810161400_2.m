...
Delta_log_GBP = calculate_DeltaAndLog(table_data_original.GBP);
EMP = calculate_EMP_2(table_data_original.CNY, table_data_original.ForeignExchangeReserve, table_data_original.ChinaBaseMoney);

data_y = Delta_log_CNY - Delta_log_GBP;
data_x = [Delta_log_USD - Delta_log_GBP, Delta_log_JPY - Delta_log_GBP, Delta_log_KRW - Delta_log_GBP, Delta_log_EUR - Delta_log_GBP, EMP];
