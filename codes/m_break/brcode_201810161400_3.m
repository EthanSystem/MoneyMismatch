...
Delta_log_CNY = calculate_DeltaAndLog_2(table_data_original.CNY);
Delta_log_USD = calculate_DeltaAndLog_2(table_data_original.USD);
Delta_log_JPY = calculate_DeltaAndLog_2(table_data_original.JPY);
Delta_log_KRW = calculate_DeltaAndLog_2(table_data_original.KRW);
Delta_log_EUR = calculate_DeltaAndLog_2(table_data_original.EUR);
Delta_log_GBP = calculate_DeltaAndLog_2(table_data_original.GBP);

Delta_EMP = calculate_EMP_3(table_data_original.CNY, table_data_original.ForeignExchangeReserve, table_data_original.ChinaBaseMoney);
