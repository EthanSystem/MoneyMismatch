...
table_data_filtered = table_data_original(1:64,:);
...
minSizeOfSegment=2;       % minimal length of a segment (minSizeOfSegment >= numRegressorsZ). Note: if isHeterogeneityAndAutocorrelation=1, minSizeOfSegment 
