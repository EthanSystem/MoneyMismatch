...
data_x = [table_data_original.USD(1:numEffectiveSample), table_data_original.EUR(1:numEffectiveSample), table_data_original.JPY(1:numEffectiveSample), table_data_original.KRW(1:numEffectiveSample), EMP];
